module dtk.backends.sdl_desktop.keyconversion;
...
Tuple!(EnumKeyboardKeyCode, Exception) convertSDLKeycodeToEnumKeyboardKeyCode(SDL_Keycode keycode)
{
    switch (keycode)
    {
    default:
    ...
    case SDL_Keycode.SDLK_BACKSPACE:
        return tuple(EnumKeyboardKeyCode.BackSpace,
                cast(Exception) null);
    ...
    case SDL_Keycode.SDLK_SEMICOLON:
        return tuple(EnumKeyboardKeyCode.Semicolon,
                cast(Exception) null);
    ...
    case SDL_Keycode.SDLK_BACKSLASH:
        return tuple(EnumKeyboardKeyCode.BackSlash,
                cast(Exception) null);
...
Tuple!(SDL_Keycode, Exception) convertEnumKeyboardKeyCodeToSDLKeycode(EnumKeyboardKeyCode keycode)
{
    switch (keycode)
    {
    default:
    ...
    case EnumKeyboardKeyCode.BackSpace:
        return tuple(SDL_Keycode.SDLK_BACKSPACE,
                cast(Exception) null);
    ...
    case EnumKeyboardKeyCode.Semicolon:
        return tuple(SDL_Keycode.SDLK_SEMICOLON,
                cast(Exception) null);
    ...
    case EnumKeyboardKeyCode.BackSlash:
        return tuple(SDL_Keycode.SDLK_BACKSLASH,
                cast(Exception) null);
...
Tuple!(SDL_Keymod, Exception) convertSingleEnumKeyboardModCodeToSDLKeymod(EnumKeyboardModCode code)
{
    ...
    {
    default:
        return tuple(cast(SDL_Keymod) 0,
                new Exception("could not decode supplied keycode: " ~ format("%s", code)));
...
Tuple!(EnumKeyboardModCode, Exception) convertCombinationSDLKeymodToEnumKeyboardModCode(
        SDL_Keymod code)
{
...
Tuple!(SDL_Keymod, Exception) convertCombinationEnumKeyboardModCodeToSDLKeymod(
