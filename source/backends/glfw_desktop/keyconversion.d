...
Tuple!(int, Exception) convertEnumKeyboardKeyCodeToGLWFKeycode(EnumKeyboardKeyCode keycode)
{
    ...
    case EnumKeyboardKeyCode.F2:
        return tuple(cast(int) GLFW_KEY_F2, cast(Exception) null);

    case EnumKeyboardKeyCode.F3:
        return tuple(cast(int) GLFW_KEY_F3, cast(Exception) null);

    case EnumKeyboardKeyCode.F4:
        return tuple(cast(int) GLFW_KEY_F4, cast(Exception) null);

    case EnumKeyboardKeyCode.F5:
        return tuple(cast(int) GLFW_KEY_F5, cast(Exception) null);

    case EnumKeyboardKeyCode.F6:
        return tuple(cast(int) GLFW_KEY_F6, cast(Exception) null);

    case EnumKeyboardKeyCode.F7:
        return tuple(cast(int) GLFW_KEY_F7, cast(Exception) null);

    case EnumKeyboardKeyCode.F8:
        return tuple(cast(int) GLFW_KEY_F8, cast(Exception) null);

    case EnumKeyboardKeyCode.F9:
        return tuple(cast(int) GLFW_KEY_F9, cast(Exception) null);

    case EnumKeyboardKeyCode.F10:
        return tuple(cast(int) GLFW_KEY_F10, cast(Exception) null);

    case EnumKeyboardKeyCode.F11:
        return tuple(cast(int) GLFW_KEY_F11, cast(Exception) null);

    case EnumKeyboardKeyCode.F12:
        return tuple(cast(int) GLFW_KEY_F12, cast(Exception) null);

    case EnumKeyboardKeyCode.F13:
        return tuple(cast(int) GLFW_KEY_F13, cast(Exception) null);

    case EnumKeyboardKeyCode.F14:
        return tuple(cast(int) GLFW_KEY_F14, cast(Exception) null);

    case EnumKeyboardKeyCode.F15:
        return tuple(cast(int) GLFW_KEY_F15, cast(Exception) null);

    case EnumKeyboardKeyCode.F16:
        return tuple(cast(int) GLFW_KEY_F16, cast(Exception) null);

    case EnumKeyboardKeyCode.F17:
        return tuple(cast(int) GLFW_KEY_F17, cast(Exception) null);

    case EnumKeyboardKeyCode.F18:
        return tuple(cast(int) GLFW_KEY_F18, cast(Exception) null);

    case EnumKeyboardKeyCode.F19:
        return tuple(cast(int) GLFW_KEY_F19, cast(Exception) null);

    case EnumKeyboardKeyCode.F20:
        return tuple(cast(int) GLFW_KEY_F20, cast(Exception) null);

    case EnumKeyboardKeyCode.F21:
        return tuple(cast(int) GLFW_KEY_F21, cast(Exception) null);

    case EnumKeyboardKeyCode.F22:
        return tuple(cast(int) GLFW_KEY_F22, cast(Exception) null);

    case EnumKeyboardKeyCode.F23:
        return tuple(cast(int) GLFW_KEY_F23, cast(Exception) null);

    case EnumKeyboardKeyCode.F24:
        return tuple(cast(int) GLFW_KEY_F24, cast(Exception) null);

    case EnumKeyboardKeyCode.A:
        return tuple(cast(int) GLFW_KEY_A, cast(Exception) null);

    case EnumKeyboardKeyCode.B:
        return tuple(cast(int) GLFW_KEY_B, cast(Exception) null);

    case EnumKeyboardKeyCode.C:
        return tuple(cast(int) GLFW_KEY_C, cast(Exception) null);

    case EnumKeyboardKeyCode.D:
        return tuple(cast(int) GLFW_KEY_D, cast(Exception) null);

    case EnumKeyboardKeyCode.E:
        return tuple(cast(int) GLFW_KEY_E, cast(Exception) null);

    case EnumKeyboardKeyCode.F:
        return tuple(cast(int) GLFW_KEY_F, cast(Exception) null);

    case EnumKeyboardKeyCode.G:
        return tuple(cast(int) GLFW_KEY_G, cast(Exception) null);

    case EnumKeyboardKeyCode.H:
        return tuple(cast(int) GLFW_KEY_H, cast(Exception) null);

    case EnumKeyboardKeyCode.I:
        return tuple(cast(int) GLFW_KEY_I, cast(Exception) null);

    case EnumKeyboardKeyCode.J:
        return tuple(cast(int) GLFW_KEY_J, cast(Exception) null);

    case EnumKeyboardKeyCode.K:
        return tuple(cast(int) GLFW_KEY_K, cast(Exception) null);

    case EnumKeyboardKeyCode.L:
        return tuple(cast(int) GLFW_KEY_L, cast(Exception) null);

    case EnumKeyboardKeyCode.M:
        return tuple(cast(int) GLFW_KEY_M, cast(Exception) null);

    case EnumKeyboardKeyCode.N:
        return tuple(cast(int) GLFW_KEY_N, cast(Exception) null);

    case EnumKeyboardKeyCode.O:
        return tuple(cast(int) GLFW_KEY_O, cast(Exception) null);

    case EnumKeyboardKeyCode.P:
        return tuple(cast(int) GLFW_KEY_P, cast(Exception) null);

    case EnumKeyboardKeyCode.Q:
        return tuple(cast(int) GLFW_KEY_Q, cast(Exception) null);

    case EnumKeyboardKeyCode.R:
        return tuple(cast(int) GLFW_KEY_R, cast(Exception) null);

    case EnumKeyboardKeyCode.S:
        return tuple(cast(int) GLFW_KEY_S, cast(Exception) null);

    case EnumKeyboardKeyCode.T:
        return tuple(cast(int) GLFW_KEY_T, cast(Exception) null);

    case EnumKeyboardKeyCode.U:
        return tuple(cast(int) GLFW_KEY_U, cast(Exception) null);

    case EnumKeyboardKeyCode.V:
        return tuple(cast(int) GLFW_KEY_V, cast(Exception) null);

    case EnumKeyboardKeyCode.W:
        return tuple(cast(int) GLFW_KEY_W, cast(Exception) null);

    case EnumKeyboardKeyCode.X:
        return tuple(cast(int) GLFW_KEY_X, cast(Exception) null);

    case EnumKeyboardKeyCode.Y:
        return tuple(cast(int) GLFW_KEY_Y, cast(Exception) null);

    case EnumKeyboardKeyCode.Z:
        return tuple(cast(int) GLFW_KEY_Z, cast(Exception) null);

    case EnumKeyboardKeyCode.Space:
        return tuple(cast(int) GLFW_KEY_SPACE, cast(Exception) null);

    case EnumKeyboardKeyCode.Zero:
        return tuple(cast(int) GLFW_KEY_0, cast(Exception) null);

    case EnumKeyboardKeyCode.One:
        return tuple(cast(int) GLFW_KEY_1, cast(Exception) null);

    case EnumKeyboardKeyCode.Two:
        return tuple(cast(int) GLFW_KEY_2, cast(Exception) null);

    case EnumKeyboardKeyCode.Three:
        return tuple(cast(int) GLFW_KEY_3, cast(Exception) null);

    case EnumKeyboardKeyCode.Four:
        return tuple(cast(int) GLFW_KEY_4, cast(Exception) null);

    case EnumKeyboardKeyCode.Five:
        return tuple(cast(int) GLFW_KEY_5, cast(Exception) null);

    case EnumKeyboardKeyCode.Six:
        return tuple(cast(int) GLFW_KEY_6, cast(Exception) null);

    case EnumKeyboardKeyCode.Seven:
        return tuple(cast(int) GLFW_KEY_7, cast(Exception) null);

    case EnumKeyboardKeyCode.Eight:
        return tuple(cast(int) GLFW_KEY_8, cast(Exception) null);

    case EnumKeyboardKeyCode.Nine:
        return tuple(cast(int) GLFW_KEY_9, cast(Exception) null);

    case EnumKeyboardKeyCode.Minus:
        return tuple(cast(int) GLFW_KEY_MINUS, cast(Exception) null);

    case EnumKeyboardKeyCode.Equals:
        return tuple(cast(int) GLFW_KEY_EQUAL, cast(Exception) null);
    ...
    case EnumKeyboardKeyCode.BackSpace:
        return tuple(cast(int) GLFW_KEY_BACKSPACE, cast(Exception) null);

    case EnumKeyboardKeyCode.Return:
        return tuple(cast(int) GLFW_KEY_ENTER, cast(Exception) null);

    case EnumKeyboardKeyCode.SquareLeftBracket:
        return tuple(cast(int) GLFW_KEY_LEFT_BRACKET, cast(Exception) null);

    case EnumKeyboardKeyCode.SquareRightBracket:
        return tuple(cast(int) GLFW_KEY_RIGHT_BRACKET, cast(Exception) null);

    case EnumKeyboardKeyCode.Semicolon:
        return tuple(cast(int) GLFW_KEY_SEMICOLON, cast(Exception) null);

    case EnumKeyboardKeyCode.SingleQuote:
        return tuple(cast(int) GLFW_KEY_APOSTROPHE, cast(Exception) null);

    case EnumKeyboardKeyCode.BackSlash:
        return tuple(cast(int) GLFW_KEY_BACKSLASH, cast(Exception) null);

    case EnumKeyboardKeyCode.Comma:
        return tuple(cast(int) GLFW_KEY_COMMA, cast(Exception) null);

    case EnumKeyboardKeyCode.Period:
        return tuple(cast(int) GLFW_KEY_PERIOD, cast(Exception) null);

    case EnumKeyboardKeyCode.Slash:
        return tuple(cast(int) GLFW_KEY_SLASH, cast(Exception) null);
    ...
    case EnumKeyboardKeyCode.Pause:
        return tuple(cast(int) GLFW_KEY_PAUSE, cast(Exception) null);

    case EnumKeyboardKeyCode.Up:
        return tuple(cast(int) GLFW_KEY_UP, cast(Exception) null);

    case EnumKeyboardKeyCode.Down:
        return tuple(cast(int) GLFW_KEY_DOWN, cast(Exception) null);

    case EnumKeyboardKeyCode.Left:
        return tuple(cast(int) GLFW_KEY_LEFT, cast(Exception) null);

    case EnumKeyboardKeyCode.Right:
        return tuple(cast(int) GLFW_KEY_RIGHT, cast(Exception) null);

    case EnumKeyboardKeyCode.KpZero:
        return tuple(cast(int) GLFW_KEY_KP_0, cast(Exception) null);

    case EnumKeyboardKeyCode.KpOne:
        return tuple(cast(int) GLFW_KEY_KP_1, cast(Exception) null);

    case EnumKeyboardKeyCode.KpTwo:
        return tuple(cast(int) GLFW_KEY_KP_2, cast(Exception) null);

    case EnumKeyboardKeyCode.KpThree:
        return tuple(cast(int) GLFW_KEY_KP_3, cast(Exception) null);

    case EnumKeyboardKeyCode.KpFour:
        return tuple(cast(int) GLFW_KEY_KP_4, cast(Exception) null);

    case EnumKeyboardKeyCode.KpFive:
        return tuple(cast(int) GLFW_KEY_KP_5, cast(Exception) null);

    case EnumKeyboardKeyCode.KpSix:
        return tuple(cast(int) GLFW_KEY_KP_6, cast(Exception) null);

    case EnumKeyboardKeyCode.KpSeven:
        return tuple(cast(int) GLFW_KEY_KP_7, cast(Exception) null);

    case EnumKeyboardKeyCode.KpEight:
        return tuple(cast(int) GLFW_KEY_KP_8, cast(Exception) null);

    case EnumKeyboardKeyCode.KpNine:
        return tuple(cast(int) GLFW_KEY_KP_9, cast(Exception) null);

    case EnumKeyboardKeyCode.KpDevide:
        return tuple(cast(int) GLFW_KEY_KP_DIVIDE,
                cast(Exception) null);

    case EnumKeyboardKeyCode.KpEnter:
        return tuple(cast(int) GLFW_KEY_KP_ENTER, cast(Exception) null);

    case EnumKeyboardKeyCode.KpEquals:
        return tuple(cast(int) GLFW_KEY_KP_EQUAL, cast(Exception) null);

    case EnumKeyboardKeyCode.KpMinus:
        return tuple(cast(int) GLFW_KEY_KP_SUBTRACT, cast(Exception) null);

    case EnumKeyboardKeyCode.KpMultiply:
        return tuple(cast(int) GLFW_KEY_KP_MULTIPLY, cast(Exception) null);

    case EnumKeyboardKeyCode.KpPlus:
        return tuple(cast(int) GLFW_KEY_KP_ADD, cast(Exception) null);
