...
Tuple!(EnumKeyboardKeyCode, Exception) convertGLWFKeycodeToEnumKeyboardKeyCode(GLWF_Keycode keycode)
{
    switch (keycode)
    {
    default:
...
Tuple!(GLWF_Keycode, Exception) convertEnumKeyboardKeyCodeToGLWFKeycode(EnumKeyboardKeyCode keycode)
{
    ...
    case EnumKeyboardKeyCode.Escape:
        return tuple(GLWF_Keycode.GLFW_KEY_ESCAPE,
                GLFW_KEY_ESC, cast(Exception) null);

    case EnumKeyboardKeyCode.F1:
        return tuple(GLWF_Keycode.GLFW_KEY_F1, cast(Exception) null);

    case EnumKeyboardKeyCode.F2:
        return tuple(GLWF_Keycode.GLFW_KEY_F2, cast(Exception) null);

    case EnumKeyboardKeyCode.F3:
        return tuple(GLWF_Keycode.GLFW_KEY_F3, cast(Exception) null);

    case EnumKeyboardKeyCode.F4:
        return tuple(GLWF_Keycode.GLFW_KEY_F4, cast(Exception) null);

    case EnumKeyboardKeyCode.F5:
        return tuple(GLWF_Keycode.GLFW_KEY_F5, cast(Exception) null);

    case EnumKeyboardKeyCode.F6:
        return tuple(GLWF_Keycode.GLFW_KEY_F6, cast(Exception) null);

    case EnumKeyboardKeyCode.F7:
        return tuple(GLWF_Keycode.GLFW_KEY_F7, cast(Exception) null);

    case EnumKeyboardKeyCode.F8:
        return tuple(GLWF_Keycode.GLFW_KEY_F8, cast(Exception) null);

    case EnumKeyboardKeyCode.F9:
        return tuple(GLWF_Keycode.GLFW_KEY_F9, cast(Exception) null);

    case EnumKeyboardKeyCode.F10:
        return tuple(GLWF_Keycode.GLFW_KEY_F10, cast(Exception) null);

    case EnumKeyboardKeyCode.F11:
        return tuple(GLWF_Keycode.GLFW_KEY_F11, cast(Exception) null);

    case EnumKeyboardKeyCode.F12:
        return tuple(GLWF_Keycode.GLFW_KEY_F12, cast(Exception) null);

    case EnumKeyboardKeyCode.F13:
        return tuple(GLWF_Keycode.GLFW_KEY_F13, cast(Exception) null);

    case EnumKeyboardKeyCode.F14:
        return tuple(GLWF_Keycode.GLFW_KEY_F14, cast(Exception) null);

    case EnumKeyboardKeyCode.F15:
        return tuple(GLWF_Keycode.GLFW_KEY_F15, cast(Exception) null);

    case EnumKeyboardKeyCode.F16:
        return tuple(GLWF_Keycode.GLFW_KEY_F16, cast(Exception) null);

    case EnumKeyboardKeyCode.F17:
        return tuple(GLWF_Keycode.GLFW_KEY_F17, cast(Exception) null);

    case EnumKeyboardKeyCode.F18:
        return tuple(GLWF_Keycode.GLFW_KEY_F18, cast(Exception) null);

    case EnumKeyboardKeyCode.F19:
        return tuple(GLWF_Keycode.GLFW_KEY_F19, cast(Exception) null);

    case EnumKeyboardKeyCode.F20:
        return tuple(GLWF_Keycode.GLFW_KEY_F20, cast(Exception) null);

    case EnumKeyboardKeyCode.F21:
        return tuple(GLWF_Keycode.GLFW_KEY_F21, cast(Exception) null);

    case EnumKeyboardKeyCode.F22:
        return tuple(GLWF_Keycode.GLFW_KEY_F22, cast(Exception) null);

    case EnumKeyboardKeyCode.F23:
        return tuple(GLWF_Keycode.GLFW_KEY_F23, cast(Exception) null);

    case EnumKeyboardKeyCode.F24:
        return tuple(GLWF_Keycode.GLFW_KEY_F24, cast(Exception) null);

    case EnumKeyboardKeyCode.A:
        return tuple(GLWF_Keycode.GLFW_KEY_A, cast(Exception) null);

    case EnumKeyboardKeyCode.B:
        return tuple(GLWF_Keycode.GLFW_KEY_B, cast(Exception) null);

    case EnumKeyboardKeyCode.C:
        return tuple(GLWF_Keycode.GLFW_KEY_C, cast(Exception) null);

    case EnumKeyboardKeyCode.D:
        return tuple(GLWF_Keycode.GLFW_KEY_D, cast(Exception) null);

    case EnumKeyboardKeyCode.E:
        return tuple(GLWF_Keycode.GLFW_KEY_E, cast(Exception) null);

    case EnumKeyboardKeyCode.F:
        return tuple(GLWF_Keycode.GLFW_KEY_F, cast(Exception) null);

    case EnumKeyboardKeyCode.G:
        return tuple(GLWF_Keycode.GLFW_KEY_G, cast(Exception) null);

    case EnumKeyboardKeyCode.H:
        return tuple(GLWF_Keycode.GLFW_KEY_H, cast(Exception) null);

    case EnumKeyboardKeyCode.I:
        return tuple(GLWF_Keycode.GLFW_KEY_I, cast(Exception) null);

    case EnumKeyboardKeyCode.J:
        return tuple(GLWF_Keycode.GLFW_KEY_J, cast(Exception) null);

    case EnumKeyboardKeyCode.K:
        return tuple(GLWF_Keycode.GLFW_KEY_K, cast(Exception) null);

    case EnumKeyboardKeyCode.L:
        return tuple(GLWF_Keycode.GLFW_KEY_L, cast(Exception) null);

    case EnumKeyboardKeyCode.M:
        return tuple(GLWF_Keycode.GLFW_KEY_M, cast(Exception) null);

    case EnumKeyboardKeyCode.N:
        return tuple(GLWF_Keycode.GLFW_KEY_N, cast(Exception) null);

    case EnumKeyboardKeyCode.O:
        return tuple(GLWF_Keycode.GLFW_KEY_O, cast(Exception) null);

    case EnumKeyboardKeyCode.P:
        return tuple(GLWF_Keycode.GLFW_KEY_P, cast(Exception) null);

    case EnumKeyboardKeyCode.Q:
        return tuple(GLWF_Keycode.GLFW_KEY_Q, cast(Exception) null);

    case EnumKeyboardKeyCode.R:
        return tuple(GLWF_Keycode.GLFW_KEY_R, cast(Exception) null);

    case EnumKeyboardKeyCode.S:
        return tuple(GLWF_Keycode.GLFW_KEY_S, cast(Exception) null);

    case EnumKeyboardKeyCode.T:
        return tuple(GLWF_Keycode.GLFW_KEY_T, cast(Exception) null);

    case EnumKeyboardKeyCode.U:
        return tuple(GLWF_Keycode.GLFW_KEY_U, cast(Exception) null);

    case EnumKeyboardKeyCode.V:
        return tuple(GLWF_Keycode.GLFW_KEY_V, cast(Exception) null);

    case EnumKeyboardKeyCode.W:
        return tuple(GLWF_Keycode.GLFW_KEY_W, cast(Exception) null);

    case EnumKeyboardKeyCode.X:
        return tuple(GLWF_Keycode.GLFW_KEY_X, cast(Exception) null);

    case EnumKeyboardKeyCode.Y:
        return tuple(GLWF_Keycode.GLFW_KEY_Y, cast(Exception) null);

    case EnumKeyboardKeyCode.Z:
        return tuple(GLWF_Keycode.GLFW_KEY_Z, cast(Exception) null);

    case EnumKeyboardKeyCode.Space:
        return tuple(GLWF_Keycode.GLFW_KEY_SPACE, cast(Exception) null);

    case EnumKeyboardKeyCode.Zero:
        return tuple(GLWF_Keycode.GLFW_KEY_0, cast(Exception) null);

    case EnumKeyboardKeyCode.One:
        return tuple(GLWF_Keycode.GLFW_KEY_1, cast(Exception) null);

    case EnumKeyboardKeyCode.Two:
        return tuple(GLWF_Keycode.GLFW_KEY_2, cast(Exception) null);

    case EnumKeyboardKeyCode.Three:
        return tuple(GLWF_Keycode.GLFW_KEY_3, cast(Exception) null);

    case EnumKeyboardKeyCode.Four:
        return tuple(GLWF_Keycode.GLFW_KEY_4, cast(Exception) null);

    case EnumKeyboardKeyCode.Five:
        return tuple(GLWF_Keycode.GLFW_KEY_5, cast(Exception) null);

    case EnumKeyboardKeyCode.Six:
        return tuple(GLWF_Keycode.GLFW_KEY_6, cast(Exception) null);

    case EnumKeyboardKeyCode.Seven:
        return tuple(GLWF_Keycode.GLFW_KEY_7, cast(Exception) null);

    case EnumKeyboardKeyCode.Eight:
        return tuple(GLWF_Keycode.GLFW_KEY_8, cast(Exception) null);

    case EnumKeyboardKeyCode.Nine:
        return tuple(GLWF_Keycode.GLFW_KEY_9, cast(Exception) null);

    case EnumKeyboardKeyCode.Minus:
        return tuple(GLWF_Keycode.GLFW_KEY_MINUS, cast(Exception) null);

    case EnumKeyboardKeyCode.Equals:
        return tuple(GLWF_Keycode.GLFW_KEY_EQUAL, cast(Exception) null);

    case EnumKeyboardKeyCode.Tabulation:
        return tuple(GLWF_Keycode.GLFW_KEY_TAB,
                cast(Exception) null);

    case EnumKeyboardKeyCode.LeftShift:
        return tuple(GLWF_Keycode.GLFW_KEY_LEFT_SHIFT,
                GLFW_KEY_LSHIFT, cast(Exception) null);

    case EnumKeyboardKeyCode.LeftControl:
        return tuple(GLWF_Keycode.GLFW_KEY_LCTRL,
                GLFW_KEY_LEFT_CONTROL, cast(Exception) null);

    case EnumKeyboardKeyCode.LeftSuper:
        return tuple(GLWF_Keycode.GLFW_KEY_LSUPER,
                GLFW_KEY_LEFT_SUPER, cast(Exception) null);

    case EnumKeyboardKeyCode.LeftAlt:
        return tuple(GLWF_Keycode.GLFW_KEY_LALT,
                GLFW_KEY_LEFT_ALT, cast(Exception) null);

    case EnumKeyboardKeyCode.RightShift:
        return tuple(GLWF_Keycode.GLFW_KEY_RIGHT_SHIFT,
                GLFW_KEY_RSHIFT, cast(Exception) null);

    case EnumKeyboardKeyCode.RightControl:
        return tuple(GLWF_Keycode.GLFW_KEY_RCTRL,
                GLFW_KEY_RIGHT_CONTROL, cast(Exception) null);

    case EnumKeyboardKeyCode.RightMenu:
        return tuple(GLWF_Keycode.GLFW_KEY_MENU,
                cast(Exception) null);

    case EnumKeyboardKeyCode.RightSuper:
        return tuple(GLWF_Keycode.GLFW_KEY_RIGHT_SUPER,
                GLFW_KEY_RSUPER, cast(Exception) null);

    case EnumKeyboardKeyCode.RightAlt:
        return tuple(GLWF_Keycode.GLFW_KEY_RALT,
                GLFW_KEY_RIGHT_ALT, cast(Exception) null);

    case EnumKeyboardKeyCode.CapsLock:
        return tuple(GLWF_Keycode.GLFW_KEY_CAPS_LOCK, cast(Exception) null);

    case EnumKeyboardKeyCode.NumLock:
        return tuple(GLWF_Keycode.GLFW_KEY_NUM_LOCK,
                GLFW_KEY_KP_NUM_LOCK, cast(Exception) null);

    case EnumKeyboardKeyCode.ScrollLock:
        return tuple(GLWF_Keycode.GLFW_KEY_SCROLL_LOCK, cast(Exception) null);

    case EnumKeyboardKeyCode.BackSpace:
        return tuple(GLWF_Keycode.GLFW_KEY_BACKSPACE, cast(Exception) null);

    case EnumKeyboardKeyCode.Return:
        return tuple(GLWF_Keycode.GLFW_KEY_ENTER, cast(Exception) null);

    case EnumKeyboardKeyCode.SquareLeftBracket:
        return tuple(GLWF_Keycode.GLFW_KEY_LEFT_BRACKET, cast(Exception) null);

    case EnumKeyboardKeyCode.SquareRightBracket:
        return tuple(GLWF_Keycode.GLFW_KEY_RIGHT_BRACKET, cast(Exception) null);

    case EnumKeyboardKeyCode.Semicolon:
        return tuple(GLWF_Keycode.GLFW_KEY_SEMICOLON, cast(Exception) null);

    case EnumKeyboardKeyCode.SingleQuote:
        return tuple(GLWF_Keycode.GLFW_KEY_APOSTROPHE, cast(Exception) null);

    case EnumKeyboardKeyCode.BackSlash:
        return tuple(GLWF_Keycode.GLFW_KEY_BACKSLASH, cast(Exception) null);

    case EnumKeyboardKeyCode.Comma:
        return tuple(GLWF_Keycode.GLFW_KEY_COMMA, cast(Exception) null);

    case EnumKeyboardKeyCode.Period:
        return tuple(GLWF_Keycode.GLFW_KEY_PERIOD, cast(Exception) null);

    case EnumKeyboardKeyCode.Slash:
        return tuple(GLWF_Keycode.GLFW_KEY_SLASH, cast(Exception) null);

    case EnumKeyboardKeyCode.Insert:
        return tuple(GLWF_Keycode.GLFW_KEY_INSERT, cast(Exception) null);

    case EnumKeyboardKeyCode.Delete:
        return tuple(GLWF_Keycode.GLFW_KEY_DEL,
                GLFW_KEY_DELETE, cast(Exception) null);

    case EnumKeyboardKeyCode.Home:
        return tuple(GLWF_Keycode.GLFW_KEY_HOME, cast(Exception) null);

    case EnumKeyboardKeyCode.End:
        return tuple(GLWF_Keycode.GLFW_KEY_END, cast(Exception) null);

    case EnumKeyboardKeyCode.PageUp:
        return tuple(GLWF_Keycode.GLFW_KEY_PAGE_UP,
                GLFW_KEY_PAGEUP, cast(Exception) null);

    case EnumKeyboardKeyCode.PageDown:
        return tuple(GLWF_Keycode.GLFW_KEY_PAGE_DOWN,
                GLFW_KEY_PAGEDOWN, cast(Exception) null);

    case EnumKeyboardKeyCode.PrintScreen:
        return tuple(GLWF_Keycode.GLFW_KEY_PRINT_SCREEN, cast(Exception) null);

    case EnumKeyboardKeyCode.Pause:
        return tuple(GLWF_Keycode.GLFW_KEY_PAUSE, cast(Exception) null);

    case EnumKeyboardKeyCode.Up:
        return tuple(GLWF_Keycode.GLFW_KEY_UP, cast(Exception) null);

    case EnumKeyboardKeyCode.Down:
        return tuple(GLWF_Keycode.GLFW_KEY_DOWN, cast(Exception) null);

    case EnumKeyboardKeyCode.Left:
        return tuple(GLWF_Keycode.GLFW_KEY_LEFT, cast(Exception) null);

    case EnumKeyboardKeyCode.Right:
        return tuple(GLWF_Keycode.GLFW_KEY_RIGHT, cast(Exception) null);

    case EnumKeyboardKeyCode.KpZero:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_0, cast(Exception) null);

    case EnumKeyboardKeyCode.KpOne:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_1, cast(Exception) null);

    case EnumKeyboardKeyCode.KpTwo:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_2, cast(Exception) null);

    case EnumKeyboardKeyCode.KpThree:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_3, cast(Exception) null);

    case EnumKeyboardKeyCode.KpFour:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_4, cast(Exception) null);

    case EnumKeyboardKeyCode.KpFive:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_5, cast(Exception) null);

    case EnumKeyboardKeyCode.KpSix:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_6, cast(Exception) null);

    case EnumKeyboardKeyCode.KpSeven:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_7, cast(Exception) null);

    case EnumKeyboardKeyCode.KpEight:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_8, cast(Exception) null);

    case EnumKeyboardKeyCode.KpNine:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_9, cast(Exception) null);

    case EnumKeyboardKeyCode.KpDevide:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_DIVIDE, cast(Exception) null);

    case EnumKeyboardKeyCode.KpEnter:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_ENTER, cast(Exception) null);

    case EnumKeyboardKeyCode.KpEquals:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_EQUAL, cast(Exception) null);

    case EnumKeyboardKeyCode.KpMinus:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_SUBTRACT, cast(Exception) null);

    case EnumKeyboardKeyCode.KpMultiply:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_MULTIPLY, cast(Exception) null);

    case EnumKeyboardKeyCode.KpPlus:
        return tuple(GLWF_Keycode.GLFW_KEY_KP_ADD, cast(Exception) null);
