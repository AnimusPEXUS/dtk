...
class Form : Widget, FormI
{
    ...
    this()
    {
        ...
        sc_focusedWidgetChange = connectToFocusedWidget_onAfterChanged(delegate void(Widget o,
                Widget n) {
            collectException({
                if (o !is null)
                {
    ...
    void nonWindowEventReceiver(Event* event)
    {
        collectException({
...

            {
                ...
                getChildAtPosition(Position2D(cast(int) form_mouse_x,
                    cast(int) form_mouse_y), mouseFocusedWidgetBreadCrumbs);
                    ...
                    }())
                {
                    ...
                    {
                        throw new Exception("parend breadcrumb is needed, but absend");
                    }
